 ...
 */
public final class FTPPractice
{
...
//                    }
    ...
    public static void printFile(InputStream input)
    {
    ...
    public static void deleteFile(FTPClient ftp)
    {
        try
        {
    ...
    public static void createPropertyFile()
    {
        ...
        InputStream input = FTPPractice.class.getResourceAsStream(name);
        if(input != null)
        {
            try
            {
        ...
        prop.setProperty("account ID", "rohankasi");
